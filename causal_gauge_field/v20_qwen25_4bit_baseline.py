...
REPORT_PATH = Path(__file__).parent / "v20_qwen25_4bit_thermo_report.json"

PROMPT = "Explain the concept of entropy in thermodynamics in two sentences."

def main():
    print("=" * 60)
    print("Qwen2.5-7B 4-bit Thermodynamic Baseline (for Ornith comparison)")
    print("=" * 60)
    ...
    print("QWEN2.5 4-BIT BASELINE COMPLETE")
